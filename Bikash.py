...
┣❥︎ 𝐂𝐫𝐞𝐚𝐭𝐨𝐫 ➪ » [𝐁𝐢𝐤𝐚𝐬𝐡](https://t.me/Mr_nobi_1)
┗━━━━━━━━━━━━━━━━━┛
...
@bot.on_message(filters.command(["/start", f"start@{BOT_USERNAME}", "/alive", ".alive", "#devil", "#ayush"]) & filters.group)
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " 💥 Owner 💞", url=f"https://t.me/Mr_nobi_1")
                ]
            ]
        ),
    )
